...
class Connection(object):   # pylint:disable=r0902,r0904
    ...
    def __init__(self, host, username=None, private_key=None, password=None,
        ...
        listAuthReq = None
        try:
            listAuthReq = self._transport.auth_none(username=self._tconnect["username"])
        except paramiko.ssh_exception.BadAuthenticationType as err :
            listAuthReq = err.allowed_types
    ...
    def _sftp_connect(self):
        ...
        if not self._sftp_live:
            self._sftp = paramiko.SFTPClient.from_transport(t=self._transport)
